...
`define AUTOTB_TVIN_x  "./c.cordiccart2pol.autotvin_x.dat"
`define AUTOTB_TVIN_y  "./c.cordiccart2pol.autotvin_y.dat"
`define AUTOTB_TVIN_x_out_wrapc  "./rtl.cordiccart2pol.autotvin_x.dat"
`define AUTOTB_TVIN_y_out_wrapc  "./rtl.cordiccart2pol.autotvin_y.dat"
`define AUTOTB_TVOUT_r  "./c.cordiccart2pol.autotvout_r.dat"
`define AUTOTB_TVOUT_theta  "./c.cordiccart2pol.autotvout_theta.dat"
`define AUTOTB_TVOUT_r_out_wrapc  "./impl_rtl.cordiccart2pol.autotvout_r.dat"
`define AUTOTB_TVOUT_theta_out_wrapc  "./impl_rtl.cordiccart2pol.autotvout_theta.dat"
module `AUTOTB_TOP;
...
assign AESL_continue = tb_continue;
  ...
  assign AESL_slave_done =  1  & control_read_data_finish;
...
initial begin : dump_tvout_runtime_sign_r
    ...
    fp = $fopen(`AUTOTB_TVOUT_r_out_wrapc, "a");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_r_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
...
reg dump_tvout_finish_theta;

initial begin : dump_tvout_runtime_sign_theta
    integer fp;
    dump_tvout_finish_theta = 0;
    ...
    // last transaction is saved at negedge right after last done
    repeat(5) @ (posedge AESL_clock);
    fp = $fopen(`AUTOTB_TVOUT_theta_out_wrapc, "a");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_theta_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
