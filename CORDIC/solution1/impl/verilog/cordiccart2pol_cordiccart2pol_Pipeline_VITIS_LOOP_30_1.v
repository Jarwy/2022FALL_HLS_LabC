...
reg   [0:0] icmp_ln1072_reg_288;
reg   [15:0] x_V_load_1_reg_292;
reg   [15:0] y_V_load_reg_298;
wire   [15:0] r_V_fu_155_p2;
reg   [15:0] r_V_reg_304;
wire   [15:0] r_V_1_fu_161_p2;
reg   [15:0] r_V_1_reg_310;
reg   [0:0] tmp_reg_316;
reg   [0:0] tmp_reg_316_pp0_iter2_reg;
reg   [11:0] angles_V_load_reg_328;
wire   [63:0] j_V_cast_fu_142_p1;
wire    ap_block_pp0_stage0;
reg   [15:0] x_V_fu_46;
wire   [15:0] x_V_3_fu_196_p3;
reg   [15:0] ap_sig_allocacmp_x_V_load_1;
wire    ap_loop_init;
reg   [15:0] y_V_fu_50;
wire   [15:0] y_V_4_fu_203_p3;
reg   [15:0] ap_sig_allocacmp_y_V_load;
reg   [4:0] j_V_fu_54;
wire   [4:0] add_ln885_fu_130_p2;
reg   [15:0] empty_fu_58;
wire   [15:0] select_ln1549_fu_238_p3;
wire    ap_block_pp0_stage0_01001;
wire   [3:0] sh_fu_147_p1;
wire   [15:0] zext_ln1452_fu_151_p1;
wire   [15:0] x_V_2_fu_188_p2;
wire   [15:0] x_V_1_fu_180_p2;
wire   [15:0] y_V_3_fu_192_p2;
wire   [15:0] y_V_2_fu_184_p2;
wire   [15:0] zext_ln712_fu_223_p1;
wire   [15:0] sub_ln712_fu_232_p2;
wire   [15:0] add_ln712_fu_226_p2;
reg    ap_done_reg;
...
cordiccart2pol_cordiccart2pol_Pipeline_VITIS_LOOP_30_1_angles_V_ROM_AUTO_1R #(
    .DataWidth( 12 ),
    .AddressRange( 16 ),
    .AddressWidth( 4 ))
angles_V_U(
...
always @ (posedge ap_clk) begin
    if (((icmp_ln1072_fu_124_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_reg_316 <= ap_sig_allocacmp_y_V_load[32'd15];
...
always @ (*) begin
    if (((icmp_ln1072_reg_288 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        p_out_ap_vld = 1'b1;
    end else begin
        p_out_ap_vld = 1'b0;
    end
...
assign add_ln712_fu_226_p2 = (zext_ln712_fu_223_p1 + empty_fu_58);
...
assign select_ln1549_fu_238_p3 = ((tmp_reg_316_pp0_iter2_reg[0:0] == 1'b1) ? sub_ln712_fu_232_p2 : add_ln712_fu_226_p2);

assign sh_fu_147_p1 = j_V_fu_54[3:0];

assign sub_ln712_fu_232_p2 = (empty_fu_58 - zext_ln712_fu_223_p1);

assign x_V_1_fu_180_p2 = (r_V_1_reg_310 + x_V_load_1_reg_292);

assign x_V_2_fu_188_p2 = (x_V_load_1_reg_292 - r_V_1_reg_310);

assign x_V_2_out = x_V_fu_46;

assign x_V_3_fu_196_p3 = ((tmp_reg_316[0:0] == 1'b1) ? x_V_2_fu_188_p2 : x_V_1_fu_180_p2);

assign y_V_2_fu_184_p2 = (y_V_load_reg_298 - r_V_reg_304);

assign y_V_3_fu_192_p2 = (r_V_reg_304 + y_V_load_reg_298);

assign y_V_4_fu_203_p3 = ((tmp_reg_316[0:0] == 1'b1) ? y_V_3_fu_192_p2 : y_V_2_fu_184_p2);

assign zext_ln1452_fu_151_p1 = sh_fu_147_p1;

assign zext_ln712_fu_223_p1 = angles_V_load_reg_328;
