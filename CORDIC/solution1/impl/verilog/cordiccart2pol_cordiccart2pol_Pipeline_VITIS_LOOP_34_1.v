...
module cordiccart2pol_cordiccart2pol_Pipeline_VITIS_LOOP_34_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [4:0] j_fu_54;
wire   [4:0] add_ln34_fu_130_p2;
reg   [15:0] empty_fu_58;
wire   [15:0] select_ln1549_fu_239_p3;
wire    ap_block_pp0_stage0_01001;
wire   [3:0] trunc_ln1386_fu_147_p1;
wire   [15:0] zext_ln1386_fu_151_p1;
...
cordiccart2pol_cordiccart2pol_Pipeline_VITIS_LOOP_34_1_angles_V_ROM_AUTO_1R #(
    .DataWidth( 12 ),
    .AddressRange( 32 ),
    .AddressWidth( 5 ))
angles_V_U(
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            j_fu_54 <= 5'd0;
        end else if (((icmp_ln34_fu_124_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln34_fu_124_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln34_fu_124_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln34_fu_124_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        p_out_ap_vld = 1'b1;
    end else begin
        p_out_ap_vld = 1'b0;
    end
...
assign add_ln34_fu_130_p2 = (j_fu_54 + 5'd1);
...
assign icmp_ln34_fu_124_p2 = ((j_fu_54 == 5'd16) ? 1'b1 : 1'b0);

assign p_out = empty_fu_58;

assign r_V_1_fu_161_p2 = $signed(ap_sig_allocacmp_y_V_load) >>> zext_ln1386_fu_151_p1;

assign r_V_fu_155_p2 = $signed(ap_sig_allocacmp_x_V_load_1) >>> zext_ln1386_fu_151_p1;
...
assign trunc_ln1386_fu_147_p1 = j_fu_54[3:0];
...
assign zext_ln1386_fu_151_p1 = trunc_ln1386_fu_147_p1;

assign zext_ln712_fu_223_p1 = angles_V_q0;

endmodule //cordiccart2pol_cordiccart2pol_Pipeline_VITIS_LOOP_34_1
