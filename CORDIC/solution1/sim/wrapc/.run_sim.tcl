...
# ==============================================================
set ::env(PATH) "$::env(PATH);E:/Xilinx_2021.2/Vitis_HLS/2021.2/win64/tools/fpo_v7_0"
set ::env(PATH) "$::env(PATH);E:/Xilinx_2021.2/Vitis_HLS/2021.2/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);E:/Xilinx_2021.2/Vitis_HLS/2021.2/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);E:/Xilinx_2021.2/Vitis_HLS/2021.2/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "cordiccart2pol.autotvin.dat"
	set constFileTvOut       "cordiccart2pol.autotvout.dat"
	set constFileHdlTvIn     "cordiccart2pol.autohdltvin.dat"
	set constFileHdlTvOut    "cordiccart2pol.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
