...
if {[file isfile cordiccart2pol.autotvin.dat]} {
	file delete -force cordiccart2pol.autotvin.dat
}

if {[file isfile cordiccart2pol.autotvout.dat]} {
	file delete -force cordiccart2pol.autotvout.dat
}
