...
#define CONTROL_ADDR_THRESHOLD_DATA 0x1c
#define CONTROL_BITS_THRESHOLD_DATA 32
#define CONTROL_ADDR_IMG_OUT_DATA   0x24
#define CONTROL_BITS_IMG_OUT_DATA   64
#define CONTROL_ADDR_ROWS_DATA      0x30
#define CONTROL_BITS_ROWS_DATA      32
#define CONTROL_ADDR_COLS_DATA      0x38
