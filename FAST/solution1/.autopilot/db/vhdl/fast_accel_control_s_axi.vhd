...
architecture behave of fast_accel_control_s_axi is
    ...
    constant ADDR_THRESHOLD_DATA_0 : INTEGER := 16#1c#;
    constant ADDR_THRESHOLD_CTRL   : INTEGER := 16#20#;
    constant ADDR_IMG_OUT_DATA_0   : INTEGER := 16#24#;
    constant ADDR_IMG_OUT_DATA_1   : INTEGER := 16#28#;
    constant ADDR_IMG_OUT_CTRL     : INTEGER := 16#2c#;
