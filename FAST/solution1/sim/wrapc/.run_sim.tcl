...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "fast_accel.autotvin.dat"
	set constFileTvOut       "fast_accel.autotvout.dat"
	set constFileHdlTvIn     "fast_accel.autohdltvin.dat"
	set constFileHdlTvOut    "fast_accel.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
